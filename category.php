...
$checkCategory = $db->query("SELECT * FROM categories WHERE id=$categoryId")->fetch();
...
$newsCard = $db->query("SELECT * FROM news WHERE category_id=$categoryId AND status='confirmation' ORDER BY id DESC");
