...
$news = $db->query("SELECT * FROM news WHERE writer_id=$sessionId ORDER BY id DESC");
...
<div class="container">
    <div class="row gy-3 align-items-center">
        ...
        <div class="col-8 text-start fs-5"><a
                class="text-decoration-none text-dark btn btn-outline-primary"
                href="./writer-create-news.php"><i class="bi bi-plus-lg text-primary"></i>
                ایجاد خبر جدید</a>
        </div>
    </div>
</div>
