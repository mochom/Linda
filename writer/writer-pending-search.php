...
if (isset($_GET['setTitle'])) {
    $title = $_GET['title'];
    $pendingNews = $db->query("SELECT * FROM news WHERE request='yes' AND writer_id=$sessionId AND title LIKE '%$title%' ORDER BY id DESC");
} else {
...
<div class="container text-center">
    <a href="./writer-pending.php" class="btn btn-outline-secondary">بازگشت</a>
</div>
